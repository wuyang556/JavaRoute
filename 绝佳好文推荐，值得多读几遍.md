...
2. - [ ] :smile:[大白话带你认识 JVM](https://juejin.im/post/6844904048013869064#heading-28)
...
4. - [ ] [常见的OOM异常分析（硬核干货）](https://mp.weixin.qq.com/s/oNWwPZ56yLCp1KQyir17AA)
...
1. - [ ] :smile:[最重要的 JVM 参数指南（翻译完善了一半）](https://snailclimb.gitee.io/javaguide/#/docs/java/jvm/最重要的JVM参数指南)
2. - [ ] :smile:[JVM 配置常用参数和常用 GC 调优策略](https://snailclimb.gitee.io/javaguide/#/docs/java/jvm/GC调优参数)
...
7. - [ ] [Java 线程生命周期与状态切换](http://www.throwable.club/2020/08/04/java-concurrency-thread-state/)
